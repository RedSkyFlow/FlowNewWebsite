    ...
    >
      ...
      <Card
        className={cn(
          ...
          "bg-card/30 backdrop-blur-lg", // Semi-transparent background with blur
          "border-none shadow-none" // Let motion div and AnimatedAccentBorder handle borders/shadows
        )}
        style={{
