        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {whyChooseItems.map((item, i) => (
            <div
              ...
              className="h-full"
            >
              <Card className="group h-full text-center bg-card rounded-xl overflow-hidden border border-border/50 flex flex-col transition-all duration-700 ease-in hover:scale-105 hover:-translate-y-1.5 shadow-[0_2px_8px_rgba(0,0,0,0.1),0_0_10px_rgba(212,175,55,0.2)] hover:shadow-[0_5px_15px_rgba(0,0,0,0.2),var(--glow-gold)] hover:border-accent/40">
