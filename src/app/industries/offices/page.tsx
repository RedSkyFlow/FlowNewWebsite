  ...
  return (
    <div className="bg-background text-foreground relative isolate overflow-hidden">
      ...
      <section className="relative h-[80vh] min-h-[500px] flex items-center justify-center text-white overflow-hidden">
        <Image
          src="/images/industries/Office WiFi.png"
          alt="A modern and professional corporate office environment."
          fill
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="perspex-card border border-accent/30 hover-glow-accent p-8 md:p-12 rounded-2xl">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <Image src="/images/industries/workspace wifi.png" alt="A dashboard showing workspace analytics and office utilization data." width={800} height={600} className="rounded-lg shadow-l4" />
                </div>
              </div>
            </div>
          </div>
