...
const WiFiMonetisationPage: NextPage = () => {
  const monetisationStrategies = [
    ...
    { 
      ...
      ctaLink: '/products/intelligent-wifi/wifi-marketing',
    },
     { 
      icon: Tv2, 
                  ...
                  <GlassCard className="flex flex-col h-full">
                    ...
                    <CardFooter>
                      <EnhancedButton asChild variant="link" className="p-0 h-auto font-semibold group">
                        <Link href={strategy.ctaLink}>Explore Strategy <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" /></Link>
                      </EnhancedButton>
                    </CardFooter>
                  </GlassCard>
                </motion.div>
