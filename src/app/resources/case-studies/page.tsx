...
const allCaseStudies = [
  ...
  { title: 'Enhancing the Guest Experience at The Grand Plaza', industry: 'Hotels', icon: Hotel, image: '/images/industries/hotels-hero.jpg', summary: 'Seamless WiFi and personalized engagement drove a 15% increase in positive reviews.', href: '#', },
  { title: 'Powering a High-Density Stadium Network', industry: 'Stadiums', icon: Drama, image: '/images/industries/Stadiums.png', summary: 'A flawless, high-density solution handled 50,000+ concurrent users without issue.', href: '#', },
