  ...
  return (
    <div className="bg-background text-foreground relative isolate overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <ScrollAnimatedSection as="div" className="pt-32 pb-20 md:pt-40 md:pb-28 text-center container mx-auto px-4 md:px-6">
        ...
        <ScrollAnimatedSection as="div" className="py-16 md:py-24 container mx-auto px-4 md:px-6">
                ...
                >
                  <GlassCard className={cn("flex flex-col h-full text-center items-center p-6", glowClasses[i % glowClasses.length])}>
                    ...
                    <CardHeader className="p-0">
                      <CardTitle className="font-headline text-xl text-foreground font-bold">{product.label}</CardTitle>
                    </CardHeader>
