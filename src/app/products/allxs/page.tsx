...
const AllxsPillarPage: NextPage = () => {
  const keyFeatures = [
    ...
    { 
      ...
      ctaLink: '/solutions/location-intelligence', // Connects to a broader solution
    },
    { 
      icon: ShoppingCart, 
      ...
      ctaLink: '/solutions/wifi-monetisation', // Connects to a broader solution
    },
  ];
      ...
      <div className="relative z-10">
        ...
        <ScrollAnimatedSection as="section" className="pt-32 pb-20 md:pt-40 md:pb-28 text-center">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <AnimatedHeading text="Allxs: The Complete Commerce & Experience Engine for Your Venue" as="h1" className="text-4xl sm:text-5xl md:text-6xl font-extrabold !leading-tight tracking-tighter" wordAnimation />
        ...
        <ScrollAnimatedSection as="section" className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <Image src="https://placehold.co/800x600.png" alt="A dashboard showing Allxs analytics with charts and graphs" width={800} height={600} className="rounded-lg shadow-l4" data-ai-hint="A sleek, dark-themed dashboard UI on a floating screen. Show key metrics like 'Total Revenue', 'Avg. Spend', and 'Guest Throughput'. Use brand colors for the chart lines." />
              </div>
            </div>
          </div>
        </ScrollAnimatedSection>
