...
import { ArrowRight, Users, Target, HeartHandshake, Eye } from 'lucide-react';
...
const AboutUsPage: NextPage = () => {
  const ourValues = [
    { 
      ...
      description: 'We don\'t innovate for the sake of technology. Every solution we build is designed to solve real-world challenges and deliver tangible, transformative value.' 
    },
    { 
      icon: HeartHandshake, 
      title: 'Partnership & Trust', 
      description: 'We believe in building lasting relationships. We act as trusted custodians of our clients\' data and strategic partners in their growth, prioritizing transparency and integrity.' 
    },
    { 
      icon: Eye, 
      title: 'A Vision for the Future', 
      description: 'We are relentlessly focused on what\'s next. Our work on the AI Gateway is a testament to our commitment to pioneering the future of intelligent physical spaces.' 
    },
  ];
        ...
        <ScrollAnimatedSection as="section" className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <Image src="/images/company/about-us-hero.jpg" alt="A diverse team of Flow Networks engineers and strategists collaborating around a digital whiteboard." width={800} height={600} className="rounded-lg shadow-l4" data-ai-hint="A candid, authentic shot of a diverse team in a modern office. They are gathered around a large interactive screen that shows an architectural diagram of our platform. The mood is collaborative, innovative, and focused. Avoid generic stock photos." />
              </div>
            </div>
          </div>
        </ScrollAnimatedSection>
        ...
        <ScrollAnimatedSection as="section" className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <Card className="perspex-card p-8 md:p-12 text-center flex flex-col items-center">
              ...
              <AnimatedHeading text="Join Our Team" as="h2" className="text-3xl sm:text-4xl font-bold mb-4" />
              <p className="mx-auto max-w-3xl text-lg text-muted-foreground font-body">
                We are always looking for passionate, innovative thinkers to join us on our mission. If you are excited by the challenge of building the future of intelligent venues, we want to hear from you.
              </p>
              <div className="mt-8">
